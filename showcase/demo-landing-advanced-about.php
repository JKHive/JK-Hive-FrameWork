...
$jk_nav = 'standalone';
$jk_page_title = 'Landing pro — About';
$jk_breadcrumb = 'Landing pro / About';
$jk_body_class = 'page-public jkhive-showcase-body admin-layout crm-layout';
$jk_demo_auth = false;
$jk_hide_demo_modal = true;
$jk_landing_pro_nav_active = 'about';
...
?>
<h1 class="jkhive-section-title" style="margin-top:0;"><?= $h('About — Landing autoadministrable') ?></h1>
...
<p style="color:var(--jk-metal-light);max-width:48rem;line-height:1.55;">Sección About editable desde panel administrativo en implementación real.</p>
<?php
