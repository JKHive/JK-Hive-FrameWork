...
$jk_landing_simple_hero_home_href = isset($jk_landing_simple_hero_home_href) ? (string) $jk_landing_simple_hero_home_href : 'landingpage/basica/index.html';
...
<section class="hero-section jkfw-landing-basic-hero jkhive-surface-panel-honeycomb-sm" aria-labelledby="<?= $h($jk_landing_simple_hero_id) ?>">
  <div class="jkfw-landing-basic-hero-logo">
    <a href="<?= $h($jk_landing_simple_hero_home_href) ?>" class="jkhive-hero-logo-link" data-tooltip="Home landing básica" aria-label="Home landing básica">
